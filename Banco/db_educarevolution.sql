...
--
-- Host: 127.0.0.1
-- Tempo de geração: 27/05/2025 às 19:24
...
--
-- Despejando dados para a tabela `tb_plano`
--

INSERT INTO `tb_plano` (`id_plano`, `nm_plano`, `vl_preco`) VALUES
(1, 'GRATUITO', 0.00),
(2, 'PREMIUM', 12.00);
...
(1, 3, '2025-05-26 17:17:50', NULL),
(2, 3, '2025-05-27 16:00:09', NULL);
...
(1, 'educarevolution', 'educa@revolution', 'educa123', NULL, 0, 0, 0),
(2, 'thiago', 'titicolucero@gmai.com', '$2y$10$TiN3MjKfoK0FsH/dAI6zQ.06muk00YWHNN9.wJAGkS6OqFKY82.Xq', NULL, 0, 0, 0),
(3, 'thiago', 'titicolucer@gmail.com', '$2y$10$TzuKd5mpabSsBUfATPmKV.T0dvWxo0Ilronih3q9vDg/LOhWtnykm', NULL, 0, 0, 0);
...
CREATE TABLE `tb_videos` (
  ...
  `video_drive_id` varchar(150) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tb_videos` (`id_video`, `nm_titulo`, `ds_descricao`, `url`, `tm_duracao`, `video_drive_id`) VALUES
(1, 'Teste', 'Este video é apenas um teste', '', '00:00:00', '1EeSOfR7lJe3YNdBkJVDsnqmvMD3ChjGf');
