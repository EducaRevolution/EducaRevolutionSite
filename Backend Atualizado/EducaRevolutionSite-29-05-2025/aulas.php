...
<body>
  ...
  <main>
    ...
    <div class="search-container">
      ...
      <form class="main__search" method="POST" action="">
          <input type="text" name="busca" class="search__input" value="<?= htmlspecialchars($busca) ?>" placeholder="Digite o título">
          <button class="btn__input-search" type="submit"><img src="imagens/lupa-icone.png" class="input__image">Buscar</button>
      </form>
              ...
              <?php foreach ($aulas as $aula): ?>
                  <div class="aulas__grid">
                      <?php if (!empty($aula['video_drive_id'])): ?>
                          <div class="grid__video" onclick="window.location.href='aulas-video.html'">
                              <img src=imagens/placeholder.png class="grid__img">
                          </div>
                      <?php else: ?>
                          <p><em>Vídeo não disponível.</em></p>
                      <?php endif; ?>

                      <h5 onclick="window.location.href='aulas-video.html'" class="grid__title"><?= htmlspecialchars($aula['nm_titulo']) ?></h5>
