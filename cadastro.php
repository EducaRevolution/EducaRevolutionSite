...
<div class="nav-overlay"></div>
    ...
    <div class="container">
        ...
        <!-- Cadastro usuários novos -->
        <div class="content first-content">

            <div class="first-colum">
                <h2 class="titulo titulo-bemvindo">Bem Vindo de Volta!</h2>
                <p class="descricao">Já tem uma conta conosco ?</p>
                <p class="descricao">Insira suas informações e conecte-se na sua conta</p>
                <button id="signin"  class="btn btn-primeiro">Entre</button>
            </div>
            <div class="second-colum">
                <h2 class="titulo-segundo">Crie sua Conta</h2>
                <p class="descricao_seg">Use seu email para se cadastrar</p>
                <form class="form">
                    ...
                    <button class="btn btn-segundo">Cadastrar</button>
                </form>
            </div>
        </div>

            <!-- Cadastro para usuarios antigos -->
            <div class="content second-content">
                
                    <div class="first-colum">
                        <h2 class="titulo titulo-bemvindo">Ainda não tem uma conta?</h2>
                        <p class="descricao">Não deixe de perder essa oportunidade!</p>
                        <p class="descricao">Insira suas informações e crie uma conta agora mesmo</p>
                        <button id="signup" class="btn btn-primeiro">Crie sua conta</button>
                    </div>
                    <div class="second-colum">
                        <h2 class="titulo-segundo">Entre na sua conta</h2>
                        <p class="descricao_seg">Use seu email para se cadastrar</p>
                        <form class="form">
                            <label class="label-input" for="">
                                <i class="fa-solid fa-user icon-modify"></i>
