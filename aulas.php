    ...
    <main>
        ...
        <article class="container">
            <div class="container__text">
                <h1>Olá <span id="user_id">Unknown!</span> <br>Bem-vindo a área de aulas</h1>
                ...
                <div class="audio-player"><img class="audio-player__image" src="imagens/megaphone-icone.png"></div>
            </div>
        </article>
        ...
        <div class="aulas">
            <div class="aulas__grid">
                ...
                <div class="grid__buttons">
                    <a href="aulas-video.html" class="buttons__anchor"><img class="buttons__icon" src="imagens/megaphone-icone.png"></a>
