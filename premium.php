...
<head>
    ...
    <title>Premium</title>
    <link rel="stylesheet" href="css/premium.css?v=1.10">
...
<script src=js/premium.js?v1.01></script>
...
<body>
   ...
   <nav class="navbar px-5">
    ...
    <ul class="nav-links mx-4">
        ...
        <li><a href="aulas.php" class="nav-item">AULAS</a></li>
        <li><a href="menu.php" class="nav-item">MENU</a></li>
        <li><a href="perfil.php" class="nav-item">PERFIL</a></li>
        <li><a href="premium.php" class="nav-item special">PLANOS</a></li>
